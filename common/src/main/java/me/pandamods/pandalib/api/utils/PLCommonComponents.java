...
public class PLCommonComponents {
	public static final Component CLOSE = Component.translatable("gui.pandalib.close");
	...
	public static final Component BACK = Component.translatable("gui.pandalib.back");
}
