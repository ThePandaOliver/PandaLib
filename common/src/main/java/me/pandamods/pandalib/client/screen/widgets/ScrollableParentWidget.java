...
public abstract class ScrollableParentWidget extends Widget {
	private final FloatInterpolator scrollInterpolator = new FloatInterpolator(.1f, 0f, 0f, 0f);
	private double scrollDistance = 0;
	private final FloatInterpolator scrollBarWidthInterpolator = new FloatInterpolator(.25f, 0f, 0f, 0f);
	private double scrollBarWidth = 0;

	protected ScrollableParentWidget(@Nullable Widget parentWidget, Screen screen) {
