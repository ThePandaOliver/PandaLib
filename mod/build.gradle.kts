...
allprojects {
    ...
    loom {
        ...
        accessWidenerPath = project(":mod").file("src/main/resources/$modId.accesswidener")
...
publishMods {
    ...
    curseforge("curseforgeFabric") {
        ...
        from(cfOptions)
        file = project(":mod:fabric").tasks.remapJar.get().archiveFile
    ...
    curseforge("curseforgeNeoForge") {
        ...
        from(cfOptions)
        file = project(":mod:neoforge").tasks.remapJar.get().archiveFile
